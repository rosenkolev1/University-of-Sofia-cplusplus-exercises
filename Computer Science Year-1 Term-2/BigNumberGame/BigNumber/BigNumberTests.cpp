...
void BigNumberTests::ConstructorAndCopyAndAssignTests()
{
...
void BigNumberTests::EqualsAndNotEqualsTests()
{
    int someNumberInt = 5678;
    char someNumberChar[] = "1234";
    BigNumber defaultBigNumber = BigNumber();
...
void BigNumberTests::OperatorGreaterThanTests()
{
    // > Operator tests
    std::cout << "\">\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorGreaterThanOrEqualsTests()
{
    // > Operator tests
    std::cout << "\">=\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorLessThanTests()
{
...
void BigNumberTests::OperatorLessThanOrEqualsTests()
{
    std::cout << "\"<=\" Operator TESTS:" << std::endl;
    std::cout << "Testing \"<=\" operator -> (100 <= -130). Expected: False, because 100 > -130:" <<
        (BigNumber(100) <= BigNumber(-130) ? "TRUE" : "FALSE") << std::endl;
...
void BigNumberTests::OperatorSumTests()
{
    // + Operator tests
    std::cout << "\"+\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorSumAndEqualsTests()
{
    // + Operator tests
    std::cout << "\"+=\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorMinusTests()
{
    // - Operator tests
    std::cout << "\"-\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorMinusAndEqualsTests()
{
    // - Operator tests
    std::cout << "\"-=\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorMultiplyTests()
{
    // - Operator tests
    std::cout << "\"*\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorMultiplyAndEqualsTests()
{
    // - Operator tests
    std::cout << "\"*=\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorDivideTests()
{
    // / Operator tests
    std::cout << "\"/\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorDivideAndEqualsTests()
{
    // /= Operator tests
    std::cout << "\"/=\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorPercentTests()
{
    // / Operator tests
    std::cout << "\"%\" Operator TESTS: " << std::endl << std::endl;
...
void BigNumberTests::OperatorPercentAndEqualsTests()
{
    // / Operator tests
    std::cout << "\"%=\" Operator TESTS: " << std::endl << std::endl;
    std::cout << (-14670187 % 163);
...
void BigNumberTests::PeshoAndLuboTests()
{
...
void BigNumberTests::SpecialTests()
{
...
{
    // getNumber() tests
    std::cout << "TESTING getNumber() TESTS: " << std::endl << std::endl;
...
{
    // getNumberRaw() tests
    std::cout << "TESTING getNumberRaw() TESTS: " << std::endl << std::endl;
