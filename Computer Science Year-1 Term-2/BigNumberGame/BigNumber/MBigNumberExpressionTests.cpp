...
void MBigNumberExpressionTests::expressionBig4Tests(std::ostream& os)
{
    ...
    MBigNumberExpression expression2(someExpression);
    MBigNumberExpression expression3(anotherExpression);
    ...
    MBigNumberExpression expression4(expression1);
    os << "Testing \"MBigNumberEquation expression4(expression1);\" \n";
    os << "Expression 4: Expected: " << someExpression << ": " << expression4.getExpression() << std::endl;

    os << std::endl;
}

void MBigNumberExpressionTests::expressionIsValidTests(std::ostream& os)
{
    ...
    //TEST 6-34
    for (size_t i = 0; i < MBigNumberExpression::EXPRESSION_FORBIDDEN_STRINGS_COUNT; i++)
    {
...
void MBigNumberExpressionTests::solveExpressionNoParenthesis_SingleNumberTests(std::ostream& os)
{
    ...
    MBigNumberExpression expression1(expressionString1);
    ...
    MBigNumberExpression expression2(expressionString2);
    ...
    MBigNumberExpression expression4(expressionString4);
    ...
    MBigNumberExpression expression5(expressionString5);
    ...
    MBigNumberExpression expression6(expressionString6);
...
void MBigNumberExpressionTests::solveExpressionNoParenthesis_AdditionAndMinusTests(std::ostream& os)
{
    ...
    MBigNumberExpression expression7(expressionString7);
    ...
    MBigNumberExpression expression8(expressionString8);
...
void MBigNumberExpressionTests::solveExpressionNoParenthesis_MultiplyTests(std::ostream& os)
{
    ...
    MBigNumberExpression expression9(expressionString9);
    ...
    MBigNumberExpression expression10(expressionString10);
    ...
    MBigNumberExpression expression11(expressionString11);
    ...
    MBigNumberExpression expression12(expressionString12);
    ...
    MBigNumberExpression expression13(expressionString13);
    ...
    MBigNumberExpression expression14(expressionString14);
    ...
    MBigNumberExpression expression15(expressionString15);
    ...
    MBigNumberExpression expression16(expressionString16);
    ...
    MBigNumberExpression expression17(expressionString17);
...
void MBigNumberExpressionTests::solveExpressionNoParenthesis_DivideTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"/\" OPERATOR: " << std::endl << std::endl;
    ...
    MBigNumberExpression expression18(expressionString18);
    ...
    MBigNumberExpression expression19(expressionString19);
    ...
    MBigNumberExpression expression20(expressionString20);
    os << "Testing expression -> (" << expressionString20 << "). Expected: " << MBigNumberExpression::EXPRESSION_DIVIDEBYZERO_EXCEPTION << ": ";
    try
    {
    ...
    MBigNumberExpression expression21(expressionString21);
    os << "Testing expression -> (" << expressionString21 << "). Expected: " << MBigNumberExpression::EXPRESSION_DIVIDEBYZERO_EXCEPTION << ": ";
    try
    {
        os << expression20.evaluateExpression();
    }
    ...
    MBigNumberExpression expression22(expressionString22);
    ...
    MBigNumberExpression expression23(expressionString23);
    ...
    MBigNumberExpression expression24(expressionString24);
    ...
    MBigNumberExpression expression25(expressionString25);
    ...
    MBigNumberExpression expression26(expressionString26);
    ...
    MBigNumberExpression expression27(expressionString27);
...
void MBigNumberExpressionTests::solveExpressionNoParenthesis_PercentTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"%\" OPERATOR: " << std::endl << std::endl;
    ...
    MBigNumberExpression expression28(expressionString28);
    ...
    MBigNumberExpression expression29(expressionString29);
    os << "Testing expression -> (" << expressionString29 << "). Expected: " << MBigNumberExpression::EXPRESSION_PERCENTBYZERO_EXCEPTION << ": ";
    try
    {
    ...
    MBigNumberExpression expression30(expressionString30);
    os << "Testing expression -> (" << expressionString30 << "). Expected: " << MBigNumberExpression::EXPRESSION_PERCENTBYZERO_EXCEPTION << ": ";
    try
    {
    ...
    MBigNumberExpression expression31(expressionString31);
    ...
    MBigNumberExpression expression32(expressionString32);
    ...
    MBigNumberExpression expression33(expressionString33);
    ...
    MBigNumberExpression expression34(expressionString34);
    ...
    MBigNumberExpression expression35(expressionString35);
    ...
    MBigNumberExpression expression36(expressionString36);
...
void MBigNumberExpressionTests::solveExpressionNoParenthesisTests(std::ostream& os)
{
...
void MBigNumberExpressionTests::solveExpressionParenthesis_SingleNumberTests(std::ostream& os)
{
...
void MBigNumberExpressionTests::solveExpressionParenthesis_AdditionAndMinusTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"+\" AND \"-\" OPERATORS: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::solveExpressionParenthesis_DivideTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"/\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::solveExpressionParenthesis_MultiplyTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"*\" OPERATOR:" << std::endl << std::endl;
...
void MBigNumberExpressionTests::solveExpressionParenthesis_PercentTests(std::ostream& os)
{
    os << "---EXPRESSION SOLVING TESTS FOR \"%\" OPERATOR: " << std::endl << std::endl;
    ...
    MBigNumberExpression expression3(expressionString3);
    os << "Testing expression -> (" << expressionString3 << "). Expected: " << MBigNumberExpression::EXPRESSION_PERCENTBYZERO_EXCEPTION << ": ";
    try
    {
        os << expression3.evaluateExpression();
    }
...
void MBigNumberExpressionTests::solveExpressionParenthesisTests(std::ostream& os)
{
    // Expression solving tests
...
void MBigNumberExpressionTests::generateExpressionTemplateTests(std::ostream& os)
{
...
void MBigNumberExpressionTests::generateExpressionTests(std::ostream& os)
{
...
void MBigNumberExpressionTests::comparativeOperatorsTests(std::ostream& os)
{
    ...
    MBigNumberExpression expression41(expressionString41);
    MBigNumberExpression expression42(expressionString42);
    ...
    MBigNumberExpression expression51(expressionString51);
    MBigNumberExpression expression52(expressionString52);
    ...
    MBigNumberExpression expression61(expressionString61);
    MBigNumberExpression expression62(expressionString62);
...
void MBigNumberExpressionTests::operatorSumTests(std::ostream& os)
{
    ...
    MBigNumberExpression expression11(expressionString11);
    MBigNumberExpression expression12(expressionString12);
    MBigNumberExpression expression13 = expression11 + expression12;
    ...
    MBigNumberExpression expression21(expressionString21);
    MBigNumberExpression expression22(expressionString22);
    MBigNumberExpression expression23 = expression21 + expression22;
...
void MBigNumberExpressionTests::operatorSumAndEqualsTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"+=\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorMinusTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"-\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorMinusAndEqualsTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"-=\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorMultiplyTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"*\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorMultiplyAndEqualsTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"*=\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorDivideTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"/\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorDivideAndEqualsTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"/=\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorPercentTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"%\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::operatorPercentAndEqualsTests(std::ostream& os)
{
    os << "EXPRESSION TESTS FOR \"%=\" OPERATOR: " << std::endl << std::endl;
...
void MBigNumberExpressionTests::readFromAndWriteToConsoleTests()
{
    ...
    MBigNumberExpression expression1 = MBigNumberExpression();
    MBigNumberExpression expression2 = MBigNumberExpression();
...
void MBigNumberExpressionTests::readFromAndWriteToFileTests(std::ostream& os)
{
...
void MBigNumberExpressionTests::runTests(std::ostream& os)
{
    std::cout << "Start the tests for MBigNumberExpression! ";
    if (&os != &std::cout)
    {
