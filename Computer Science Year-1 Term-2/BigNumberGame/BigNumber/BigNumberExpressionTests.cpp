...
void BigNumberExpressionTests::expressionBig4Tests(std::ostream& os)
{
    ...
    os << "Expression 1: Expected: " << "{empty}" << ": " << (strcmp(expression1.getExpression(), "0") == 0 ? "{empty}" : "WRONG") << std::endl;
...
void BigNumberExpressionTests::expressionIsValidTests(std::ostream& os)
{
    ...
    os << "Testing if expression is valid-> " << expressionString35 << ". Expected: FALSE: " << (expression.expressionIsValid(expressionString35) ? "TRUE" : "FALSE");
    os << std::endl;
    os << std::endl;
    ...
    os << "Testing if expression is valid-> " << expressionString36 << ". Expected: FALSE: " << (expression.expressionIsValid(expressionString36) ? "TRUE" : "FALSE");
    os << std::endl;
    os << std::endl;
    ...
    os << "Testing if expression is valid-> " << expressionString37 << ". Expected: FALSE: " << (expression.expressionIsValid(expressionString37) ? "TRUE" : "FALSE");
    os << std::endl;
    os << std::endl;
...
void BigNumberExpressionTests::generateExpressionTests(std::ostream& os)
{
    ...
    for (size_t i = 50; i < 99; i++)
    {
        ...
        os << ". Is the expression valid? Expect: TRUE: " << (expression.expressionIsValid() && !StringManip::stringContains(expression.getExpression(), "%") ? "TRUE" : "FALSE") << std::endl;
        os << "Answer to the expression --> ";
        try
        {
            os << expression.evaluateExpression();
...
void BigNumberExpressionTests::operatorSumTests(std::ostream& os)
{
    ...
    os << "Are these expressions the same: " << (strcmp(expectedOuput1, expression13.getExpression()) == 0 ? "TRUE" : "FALSE") << std::endl;
    ...
    os << "Are these expressions the same: " << (strcmp(expectedOuput2, expression23.getExpression()) == 0 ? "TRUE" : "FALSE") << std::endl;
...
void BigNumberExpressionTests::operatorSumAndEqualsTests(std::ostream& os)
{
    ...
    os << "Are these expressions the same: " << (strcmp(expectedOuput1, expression11.getExpression()) == 0 ? "TRUE" : "FALSE") << std::endl;
    ...
    os << "Are these expressions the same: " << (strcmp(expectedOuput2, expression21.getExpression()) == 0 ? "TRUE" : "FALSE") << std::endl;
