...
void exerciseThree()
{
    ...
    //Make the number of digits divisible by 8
    numberOfDigits = numberOfDigits / 8 * 8;
    ...
    for (int i = 1; i <= numberOfDigits; i++)
    {
        ...
        else if (i % 4 == 0 && i % 8 == 0 && currentlyCountingTypeCode == true)
        {
...
void exerciseFour()
{
    ...
    cout << endl << "The sum of the interesting numbers is: " << sumOfInterestingNumbers;
}
